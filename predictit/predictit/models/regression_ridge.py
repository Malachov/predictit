...
def regression_ridge(data, n_steps_in=50, predicts=7, predicted_column_index=0, output_shape='one_step', other_columns_lenght=None, constant=None, alpha=0.5, solver='auto'):
