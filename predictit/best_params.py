...
def optimize(
    ...
    Args:
        ...
        model_train_input (np.array or tuple(np.ndarray, np.ndarray, np.ndarray)): Data on which function is optimized.
    ...
    for iteration in range(iterations):
        ...
        if (
            (memory_result != 0 and round(memory_result, 6) == round(best_result, 6))
