...
class config():
    ...
    remove_nans = 'any_columns'  # 'any_columns' will remove all the columns where is at least one nan column. 'any_rows' delete each row, here is nan value
    ...
    standardizeit = 0  # 'standardize'  # One from None, 'standardize', '-11', '01', 'robust'.
    ...
    smoothit = (11, 2)  # Smoothing data with Savitzky-Golay filter. First argument is window and second is polynomial order. If 0, not smoothing.
