"""Module, that create memory and time profile of used functions in data preprocessing.
It is used to know, if the operations are made inplace as much as possible."""
