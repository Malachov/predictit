...
data_multi_col = np.array([[1, 22, 3, 3, 5], [5, 6, 7, 6, 7], [8, 9, 10, 6, 8]])
...
# seqs, Y, x_input = dp.make_sequences(data, n_steps_in=6, n_steps_out=1, constant=1, predicted_column_index=0, other_columns_length=None)
# print(f"Original: \n {data} \n\nsequences: \n{seqs} \n\nY: \n{Y} \n \n\n{x_input} \n")

print('### Make sequences - Batch ### \n')
seqs_2, Y_2, x_input2 = dp.make_sequences(data, n_steps_in= 5, n_steps_out= 1, other_columns_length= 3, constant= 1)
print(f"Original: \n {data} \n\nsequences: \n{seqs_2} \n\nY: \n{Y_2} \n \n\n{x_input2} \n")

# print('### Fitt power transform ### \n')
# fitted = dp.fitted_power_transform(data, 10, 10)
# print(f"Original: \n {data}, original std = {data.std}, original mean = {data.mean} \n\ntransformed: \n{fitted} \n\ntransformed std = {fitted.std()}, transformed mean = {fitted.mean()} (shoud be 10 and 10)\n")
...
# print('### Make sequences - One step ### \n')
# seqs = dp.make_sequences(data_multi_col, n_steps_in=3, n_steps_out=1, constant=1, predicted_column_index=0, other_columns_length=None)
# print(f"Original: \n {data_multi_col} \n\nsequences X: \n{seqs[0]} \n\ny: \n{seqs[1]} \n \n\n x_input: {seqs[2]} \n")



# print('### Make sequences - Batch ### \n')
# seqs_2, Y_2, x_input2 = dp.make_sequences(data_multi_col, n_steps_in=2, n_steps_out=2, constant=None, predicted_column_index=0, other_columns_length=None)
# print(f"Original: \n {data_multi_col} \n\nsequences: \n{seqs_2} \n\nY: \n{Y_2} \n \n\n{x_input2} \n")
...
# power_transformed = dp.fitted_power_transform(data, 10, 10)
# print(f"Original std = {np.std(data)} Original mean = {np.mean(data)}. Wanted standard deviation = 10, mean = 10: \n\nresult std: \n{np.std(power_transformed)} \n\ntransformed mean: \n{np.mean(power_transformed)} \n")
