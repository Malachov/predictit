...
def regression_ridge_CV(data, n_steps_in=50, predicts=7, predicted_column_index=0, output_shape='one_step', other_columns_lenght=None, constant=None, alphas=[0.1, 0.5, 1], gcv_mode='auto'):
